...
import StakingRoute from "./pages/dashboard/staking/route";
...
import NamesMarketplacePage from "./pages/names/marketplace";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<AppLayout />}>
            ...
            <Route path="/dashboard/create/nft" element={<NFTsPage />} />
            <Route
            ...
            />
            <Route path="/dashboard/staking" element={<StakingRoute />} />
            ...
            <Route path="/nfts/:id" element={<NFTsPage />} />
            <Route path="/names" element={<NamesPage />} />
            <Route path="/names/marketplace" element={<NamesMarketplacePage />} />
